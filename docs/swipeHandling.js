const works = [
  ...
  },
  {
    ...
    image: "assets/project/reference/solara-option1.jpg",
    secondary: [
      { path: "assets/project/reference/solara-panel-rotation.jpg", mirror: true },
      "assets/project/reference/solara-physical-model.jpg",
      "assets/project/reference/solara-render.jpg",
      "assets/0318.mov",
    ...
    evidence: [
      { type: "media", kind: "RENDER", label: "SOLARA facade render", path: "assets/project/reference/solara-render.jpg", caption: "Facade render from the SOLARA public website." },
  ...
  },
  {
    ...
    image: "assets/project/architecture/pages/dtbr-4.jpg",
    uniformFrames: true,
    uniformFit: "contain",
    ...
    pageFrames: [
      { path: "assets/project/architecture/pages/dtbr-1.jpg", label: "Office Building Design at DTBR page 1" },
      { path: "assets/project/architecture/pages/dtbr-2.jpg", label: "Office Building Design at DTBR page 2" },
      { path: "assets/project/architecture/pages/dtbr-3.jpg", label: "Office Building Design at DTBR page 3" },
      { path: "assets/project/architecture/pages/dtbr-4.jpg", label: "Office Building Design at DTBR page 4" }
    ],
    evidence: [
      { type: "media", kind: "PDF", label: "DTBR preview", path: "assets/project/architecture/pages/dtbr-1.jpg", caption: "" }
    ],
  ...
  },
  {
    ...
    indexGroup: "Architectural Design and System",
    image: "assets/project/architecture/stadium-collage.jpg",
    uniformFrames: true,
    uniformFit: "contain",
    role: "Architectural designer",
    ...
    pageFrames: [
      { path: "assets/project/architecture/pages/harborfront-1.jpg", label: "Harborfront Park page 1", caption: "Opening board from the Harborfront Park PDF." },
      { path: "assets/project/architecture/pages/harborfront-2.jpg", label: "Harborfront Park page 2", caption: "Second board from the Harborfront Park PDF." },
      { path: "assets/project/architecture/pages/harborfront-3.jpg", label: "Harborfront Park page 3", caption: "Third board from the Harborfront Park PDF." }
    ],
    evidence: [
      { type: "media", kind: "PDF", label: "Harborfront preview", path: "assets/project/architecture/pages/harborfront-1.jpg", caption: "" }
    ],
  ...
  },
  {
    ...
    pageFrames: [
      { path: "assets/project/architecture/pages/green-wall-1.jpg", label: "Green Wall page 1", caption: "Opening page from the Green Wall Systems & Fabrication PDF." },
      { path: "assets/project/architecture/pages/green-wall-2.jpg", label: "Green Wall page 2", caption: "Second page from the Green Wall Systems & Fabrication PDF." }
    ],
    evidence: [
      { type: "media", kind: "PDF", label: "Green wall preview", path: "assets/project/architecture/pages/green-wall-1.jpg", caption: "" }
    ],
  ...
  },
  {
    ...
    indexGroup: "Architectural Design and System",
    image: "assets/project/architecture/pages/continual-selected-3.jpg",
    uniformFrames: true,
    uniformFit: "contain",
    role: "Architectural designer",
    ...
    pageFrames: [
      { path: "assets/project/architecture/pages/continual-selected-3.jpg", label: "Continual Delay page 3" },
      { path: "assets/project/architecture/pages/continual-selected-4.jpg", label: "Continual Delay page 4" },
      { path: "assets/project/architecture/pages/continual-selected-5.jpg", label: "Continual Delay page 5" },
      { path: "assets/project/architecture/pages/continual-selected-7.jpg", label: "Continual Delay page 7" }
    ],
    evidence: [
      { type: "media", kind: "PDF", label: "Continual Delay preview", path: "assets/project/architecture/pages/continual-selected-3.jpg", caption: "" }
    ],
  ...
  },
  {
    ...
    indexGroup: "Architectural Design and System",
    image: "assets/project/architecture/form-exploration-2020.jpg",
    uniformFrames: true,
    uniformFit: "contain",
    role: "Designer",
    ...
    evidence: [
      { type: "media", kind: "MODEL", label: "Cubic space model", path: "assets/project/architecture/form-exploration-2020.jpg", caption: "" }
    ],
  ...
  },
  {
    ...
    indexGroup: "Architectural Design and System",
    image: "assets/project/BIM/overview1.jpg",
    uniformFrames: true,
    uniformFit: "contain",
    secondary: [
      "assets/project/BIM/BIM-climateanalysis.jpg",
      "assets/project/BIM/facade_gh.jpg",
    ...
    evidence: [
      ...
      { type: "media", kind: "FACADE", label: "Grasshopper facade workflow", path: "assets/project/BIM/facade_gh.jpg", caption: "Parametric facade/form-finding translated into BIM documentation." },
  ...
  },
  {
    ...
    indexGroup: "Prototypes",
    image: "assets/project/reference/review-scraper-hero.jpg",
    landscapeFrames: true,
    ...
    evidence: [
      { type: "media", kind: "WEB", label: "Review scraper page screenshot", path: "assets/project/reference/review-scraper-hero.jpg", caption: "" },
