...
var flip = (function()
{
            ...
            setTimeout( function() {
                ...
                setTimeout( function() {
                    ...
                    setTimeout( function() {
                        ...
                        setTimeout( onTransitionEndPrev, 340 );
                    }, 320 );
                }, 10 );
            }, 0 );
        }
            ...
            setTimeout( function() {
                ...
                setTimeout( function() {
                    ...
                    setTimeout( function() {
                        ...
                        setTimeout( onTransitionEndNext, 340 );
                    }, 320 );
                }, 10 );
            }, 0 );
        }
    ...
    // Portfolio adapter: show an arbitrary page without animating through every
    // preceding page. Transitions after the jump still use flip.push/pop.
    flip.jumpTo = function( newPage, previousPages, followingPage, firstPage )
    {
        var resetPage = function( page )
        {
            ...
            page.html.className = 'flip-page-wrapper';
            page.flip.className = 'flip-page-wrapper';
            page.html.removeAttribute( 'style' );
            page.flip.removeAttribute( 'style' );
        };
        ...
        while( flipPagesContainer.firstChild ) {
            flipPagesContainer.removeChild( flipPagesContainer.firstChild );
        }

        pageStack = previousPages.slice( 0 );
        topPage = newPage;
        prevPage = pageStack.length ? pageStack[ pageStack.length - 1 ] : null;
        nextPage = null;
        frontPage = firstPage || newPage;

        previousPages.forEach( resetPage );
        resetPage( topPage );
        resetPage( followingPage );
